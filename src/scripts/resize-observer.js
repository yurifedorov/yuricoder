/*
  ...
  Script to work "ResizeObserver"
  Author - Philip Walton (Google Developers)
  GitHub - https://github.com/philipwalton/responsive-components
...
(function() {
  ...
  var defaultBreakpoints = {SM: 384, MD: 576, LG: 768, XL: 960, XXL: 1440};
  // A technique for loading polyfills only when needed. Details here:
  // https://philipwalton.com/articles/loading-polyfills-only-when-needed/
  if ((typeof ResizeObserver === 'undefined' ||
      typeof customElements === 'undefined') &&
      matchMedia('(min-width: ' + defaultBreakpoints.SM + 'px)').matches) {
